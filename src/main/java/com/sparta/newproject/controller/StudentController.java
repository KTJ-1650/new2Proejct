...
public class StudentController {
    ...
    //3단계 2)수정일 조회
    @GetMapping("/modified")
    public List<StudentResponseDto> modified_day(@RequestParam(required = false) String modifieday, @RequestParam(required = false) String name){
        System.out.println("modifieday = " + modifieday);
        System.out.println("name = " + name);
        return studentService.modified_day(modifieday,name);
    }

    //3단계. 3)담당자 조회
    @GetMapping("/chargename")
    public List<StudentResponseDto> chargename(@RequestBody StudentRequestDto requestDto){
    ...
    public  List<StudentResponseDto> modicharge(@RequestBody StudentRequestDto requestDto){
    ...
    @PutMapping
    public int tocharge(@RequestBody StudentRequestDto requestDto){
